	...
	return (
		<div className="infoCard">
			...
			<p className="personalInfo">
				I graduated from Lake Forest College (Illinois, USA) in 2019 with a BA in Finance after
				which I became a Full Stack developer because I was inclined to pursue a career that would allow me to
